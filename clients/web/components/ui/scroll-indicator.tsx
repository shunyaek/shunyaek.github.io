    ...
    <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50 flex flex-col gap-3">
      {Array.from({ length: totalSections }, (_, index) => (
        ...
        >
          ...
          {/* Label tooltip */}
          <div
            className={`absolute right-6 whitespace-nowrap bg-background/95 backdrop-blur-sm border rounded-lg px-3 py-1.5 text-sm font-medium transition-all duration-300 shadow-lg ${currentSection === index
