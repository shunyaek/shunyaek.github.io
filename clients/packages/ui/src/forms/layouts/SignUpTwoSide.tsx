      ...
      >
        ...
        >
          ...
          >
            ...
            <View flexDirection="column" gap="$1">
              <Label htmlFor={uniqueId + '1-marital-status'} lineHeight={'$5'}>
                Marital Status
              </Label>
              <RadioGroup
                gap="$8"
            ...
            <View flexDirection="column" gap="$1">
              <Label htmlFor={uniqueId + 'country'} lineHeight={'$5'}>
                Country
              </Label>
          ...
          <View flexDirection="column" gap="$4" flex={1} flexBasis={200}>
            ...
            <Checkboxes
              ...
              gap="$2.5"
            >
              <Checkboxes.Title fontSize="$4" fontWeight="$3" paddingBottom={0}>
    ...
    <Select id={id} value={val} onValueChange={setVal} disablePreventBodyScroll>
      <Select.Trigger width="100%" iconAfter={ChevronDown}>
        <View flexDirection="row" gap="$3" justifyContent="center" alignItems="center">
          ...
          <Text marginRight="auto">{`${selectedItem.name} ${selectedItem.shortName ? `(${selectedItem.shortName})` : ''
            }`}</Text>
        </View>
      </Select.Trigger>
                ...
                data.map((item, i) => {
                  return (
                    ...
                    >
                      ...
                      <Text marginRight="auto">{`${item.name} ${item.shortName ? `(${item.shortName})` : ''
                        }`}</Text>
